...
export const ko: TranslationKeys = {
  ...
  stats: {
    everyoneTitle: '모두의 통계',
    mySummaryTitle: '나의 분석 요약',
    rankingTitle: '선호도 \"좋아요\" 비율 랭킹 (Top 10)',
    rankingLoading: '랭킹 수집 중...',
    emptyData: '데이터가 아직 충분히 수집되지 않았습니다',
