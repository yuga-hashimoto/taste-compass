...
export const pt: TranslationKeys = {
  ...
  home: {
    ...
    feature2Desc: 'Comparação global, corpo e idade',
  ...
  setup: {
    ...
    pageSub: 'Escolha a quantidade para começar',
  ...
  stats: {
    everyoneTitle: 'Estatísticas de Todos',
    mySummaryTitle: 'Resumo da Sua Análise',
    rankingTitle: 'Classificação de Taxa de Like (Top 10)',
    rankingLoading: 'Coletando classificações...',
    emptyData: 'Dados insuficientes acumulados ainda',
