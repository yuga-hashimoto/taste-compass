...
export const id: TranslationKeys = {
  ...
  home: {
    ...
    feature2Desc: 'Perbandingan global, tubuh & usia',
  ...
  stats: {
    everyoneTitle: 'Statistik Semua Orang',
    mySummaryTitle: 'Ringkasan Analisis Anda',
    rankingTitle: 'Peringkat Persentase "Suka" (Top 10)',
    rankingLoading: 'Mengumpulkan peringkat...',
    emptyData: 'Data belum cukup terkumpul',
