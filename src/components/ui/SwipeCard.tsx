    ...
    >
      <View style={styles.card}>
        ...
        <Animated.View
          style={[
            styles.colorOverlay,
            { backgroundColor: THEME.colors.like, opacity: Animated.multiply(likeOpacity, 0.2) },
          ]}
          pointerEvents="none"
        />
        ...
        <Animated.View
          style={[
            styles.colorOverlay,
            { backgroundColor: THEME.colors.skip, opacity: Animated.multiply(skipOpacity, 0.2) },
          ]}
          pointerEvents="none"
        />
